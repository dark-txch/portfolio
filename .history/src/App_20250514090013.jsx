			...
			<div className="w-screen h-full ">
				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] lg:flex lg:justify-center lg:items-center">
					...
					<div className="relative w-screen h-[50dvh] flex flex-col justify-end items-center lg:h-[100vh] lg:flex lg:justify-center lg:w-[50vw]">
						...
						/>
						<div class="flex justify-between items-center w-full px-[2rem] lg:flex lg:flex-col lg:items-end lg:border-2 lg:border-solid lg:border-red-500 lg:h-[10rem] lg:overflow-hidden lg:relative">
							<h1 class="relative text-[1.5rem] lg:text-[3rem] text-white flex justify-between w-full lg:w-auto lg:flex-initial lg:justify-center">
								<span>Ebenezer</span>
								<span class="lg:hidden">Tiewei</span>
							</h1>
							<h4 class="relative text-[1rem] text-white hidden lg:block">
								Front End
							</h4>
						</div>
					...
					<div className="relative w-screen h-[50dvh] flex flex-col justify-start items-centerlg:h-[100vh] lg:flex lg:justify-center lg:w-[50vw]">
						<BackgroundVideo
						...
						<div className="flex justify-between items-center w-full px-[2rem] lg:flex lg:flex-col lg:items-start lg:border-2 lg:border-solid lg:border-red-500 lg:h-[10rem] lg:overflow-hidden lg:relative">
							{/* Show only on lg */}
