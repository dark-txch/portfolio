		...
		<>
			...
			<div className="w-screen h-full ">
				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF]">
					...
					<div className="relative w-screen h-[100dvh] flex flex-col justify-end items-center lg:h-[100vh] border-[0.2px] border-[#4E71FF]">
						<BackgroundVideo
							src="/video/gym-s.mp4"
						...
						<div className="flex justify-between items-center w-full px-[2rem]">
							<h1 className="relative text-[2rem] lg:text-[5rem]">Ebenezer</h1>
