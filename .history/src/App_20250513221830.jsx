				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] lg:flex lg:justify-center lg:items-center">
					...
					<div className="relative w-screen h-[50dvh] flex flex-col justify-end items-center lg:h-[100vh] lg:w-[50vw]">
						...
						<div className="flex justify-between items-center w-full px-[2rem]">
							<h1 className="relative text-[1.5rem] lg:text-[5rem] text-white flex justify-between w-[100vw]">
								Ebenezer
								<span className="">Tiewei</span>
							</h1>
							<h4 className="relative text-[1rem] text-white hidden">
								Front End
							</h4>
						</div>
					...
					<div className="relative w-screen h-[50dvh] flex flex-col justify-start items-center lg:h-[100vh] lg:w-[50vw] lg:justify-center">
						...
						<div className="flex justify-between items-center w-full px-[2rem] lg:flex lg:flex-col">
							<h1 className="relative text-[2rem] text-white hidden">Tiewei</h1>
							<h4 className="relative text-[1rem] text-white flex justify-between w-[100vw]">
								Developer
								<span className="order-0">Front end</span>
							</h4>
						</div>
					</div>
				</header>
