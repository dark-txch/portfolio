			...
			<div className="w-screen h-full ">
				...
				<main className="-translate-y-full">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className="text-[0.4rem] w-screen h-[7rem] border-[0.3rem] border-solid border-red-500 motion-scale-in-[0.5] motion-opacity-in-[0%]">
							<ul className="text-white text-[1rem] flex justify-center items-center w-full h-full">
								<li>Home</li>
								<li>About</li>
								<li>Projects</li>
								<li>Contact</li>
