				...
				>
					...
					>
						...
						<div className="relative flex justify-between items-start w-full px-[1rem] overflow-hidden lg:flex lg:flex-col lg:items-start lg:px-0">
							...
							<button
								onClick={handleClick}
								className="relative bottom-[2rem] text-[#60B5FF] text-[1.1rem] font-bold bg-[#CB0404]  rounded-b-[5rem] border-[0.6rem] border-[#60B5FF] w-[5rem] h-[4.5rem] cursor-pointer overflow-hidden lg:bottom-auto lg:mx-0 lg:rounded-b-none lg:rounded-tr-[3rem] lg:rounded-br-[3rem] lg:my-[1rem] lg:right-[2.7rem] lg:uppercase lg:order-1"
							>
