			...
			<div className="w-screen h-full ">
				...
				<main className="-translate-y-full">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className="w-screen h-[7rem] border-[0.3rem] border-solid border-red-500 motion-scale-in-[0.5] motion-opacity-in-[0%]">
							<ul className="flex justify-center items-center w-full h-full text-[0.5rem]">
