		...
		<>
			...
			<div className="w-screen h-full ">
				...
				<header className="w-screen h-[100dvh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF]">
					...
					<div className="relative w-screen h-[50dvh] flex flex-col justify-end items-center">
						<BackgroundVideo
							src="/video/gym-s.mp4"
						...
						<div className="hidden">
							<h1 className="relative">Ebenezer</h1>
						...
						<div className="flex justify-between items-center w-full px-[2rem]">
							<h1 className="relative text-[2rem]">Ebenezer</h1>
							<h4 className="relative text">Front End</h4>
						</div>
						<span>
							<p>
