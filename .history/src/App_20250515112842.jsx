				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] overflow-hidden lg:flex lg:justify-center lg:items-center">
					...
					>
						...
						<div className="relative flex justify-between items-start w-full px-[1rem] overflow-hidden lg:flex lg:flex-col lg:items-start lg:px-0">
							...
							<button
								onClick={handleClick}
								className="relative bottom-[2rem] text-[#b9b9b9] text-[1.rem] font-bold bg-[#CB0404]  rounded-b-[5rem] border-[0.8rem] border-[#3A0519] w-[5rem] h-[4.5rem] cursor-pointer overflow-hidden lg:bottom-auto lg:mx-0 lg:rounded-b-none lg:rounded-tr-[3rem] lg:rounded-br-[3rem] lg:my-[1rem] lg:right-[2.7rem] lg:uppercase lg:order-1"
							>
