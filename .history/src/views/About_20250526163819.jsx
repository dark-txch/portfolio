import EbenezerLinkedin from "../assets/About/EbenezerLinkedin.png";
		...
		<AnimatePresence mode="wait">
			...
			>
				<div className="flex flex-col justify-center lg:flex-row">
					...
					<div className="lg:w-[30%] mt-[5rem] px-[1rem] lg:mt-0 lg:pt-[5rem] lg:order-2 ">
						<img src={EbenezerLinkedin} loading="lazy" alt="EbenezerLinkedin" className="rounded-[5rem]" />
					</div>
				</div>
