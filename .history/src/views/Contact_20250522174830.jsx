	...
	return (
		<div className="bg-[#1c1860] h-auto flex flex-col justify-between mx-[1rem] mt-[5rem] mb-[10rem] px-[1rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:mx-auto lg:flex-row lg:gap-[4rem]  lg:py-[5rem] lg:px-[2rem]">
			...
			>
				...
				<button
					type="submit"
					className="w-full font-thin text-cyan-200 text-[1rem]  py-2 border border-cyan-300 rounded-[1rem] hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-500"
				>
					Send Message
				</button>
			</form>
