...
export default function Contact() {
	...
	return (
		<div className="bg-[#1c1860] w-[80%] h-auto mx-auto flex flex-col justify-between border-[0.1px] border-cyan-200 mt-[5rem] mb-[10rem] px-[2rem] lg:flex-row  lg:py-[5rem]">
			<div className="w-full flex flex-col items-center">
				<h1 className="font-unna font-bold  text-[2.5rem] text-cyan-200 px-[1rem] ">
					Let's collaborate
				</h1>
				<p className="font-thin text-[#EAE4D5] text-[1.4rem] leading-[2.5rem] px-[1rem] mb-[2rem]">
