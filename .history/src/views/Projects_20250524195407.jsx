...
export default function Projects() {
	...
	const portfolioSummary = [
		{
			summary:
				"My portfolio website built to showcase my frontend projects, skills, and contact information. Fully responsive, built with modern tools, and includes interactive UI elements.",
