		...
		<AnimatePresence mode="wait">
			...
			>
				...
				<div className="flex justify-center w-screen mx-auto mt-20 mb-[10rem] lg:w-[65%] lg:mx-auto">
					<Link
						to="/about"
						className="inline-block uppercase text-[1rem] text-cyan-200 border shadow-deep border-cyan-500 px-6 py-3 rounded-full hover:bg-cyan-500 hover:text-[#0C0950] hover:text-bold transition-all duration-500"
					>
						More about me
					</Link>
				</div>
