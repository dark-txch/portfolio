			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className="relative text-white text-[1rem] w-screen shadow  px-[1rem] uppercase border-[0.3rem] border-solid border-red-500 lg:flex lg:items-center lg:justify-between ">
							<ul>
							...
							<button className="relative" onClick={toggleMenu} aria-label=""></button>
							{/*Hamburger menu Top Section: Navigation Links */}
							<ul className="bg-black flex flex-col gap-4 items-center pt-[1rem] pb-[2rem] left-0 right-0 border border-solid border-gray-500">
								<li className="hover:text-cyan-500 duration-500">
