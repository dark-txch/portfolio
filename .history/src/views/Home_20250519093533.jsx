			...
			>
				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] overflow-hidden lg:flex lg:justify-center lg:items-center">
					...
					>
						...
						<div className="relative flex justify-between items-end w-full px-[1rem] overflow-hidden lg:flex lg:flex-col lg:items-end lg:px-0">
							<h1 className="text-[#60B5FF] text-[1.5rem] uppercase font-bold w-[7rem] pb-[0.5rem] lg:w-[15rem] lg:pr-[1rem] lg:text-right lg:text-[1rem] lg:order-5">
								Ebenezer
							</h1>
							...
							<h4 className="text-[1.5rem] text-[#60B5FF] font-bold text-right pr-[0.6rem] uppercase w-[7rem] pb-[0.5rem] lg:w-[15rem] lg:pl-[1rem] lg:text-[2rem] lg:order-4">
								Frontend
							</h4>
						</div>
					</div>
					...
					>
						...
						<div className="relative flex justify-between items-start w-full px-[1rem] overflow-hidden lg:flex lg:flex-col lg:items-start lg:px-0">
							<h1 className="text-[#60B5FF] text-[1.5rem] font-bold uppercase w-[7rem] pt-[0.5rem] lg:pt-0 lg:pb-[0.5rem] lg:w-[15rem] lg:pl-[1rem] lg:text-[1rem] lg:order-5">
								Tiewei
							</h1>
							...
							<h4 className="text-[1.5rem] text-[#60B5FF] font-bold text-right pr-[0.3rem] uppercase w-[7rem] pt-[0.5rem] lg:text-left lg:text-[2rem] lg:pb-[0.5rem] lg:pt-0 lg:w-[15rem] lg:pl-[1rem] lg:text-[2rem] lg:order-4">
								Developer
							</h4>
						</div>
					</div>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className="relative text-white text-[1rem] w-screen shadow flex justify-between px-[1rem] py-[1.5rem] uppercase lg:flex lg:items-center lg:justify-between lg:pt-[2rem] lg:px-[3rem]">
							...
							<div className="flex gap-5 lg:gap-[2rem]">
								<button
						...
						{/* Body of the header */}
						<h1 className="text-cyan-500 text-center mt-[4rem] text-[2.5rem] mb-[1.5rem]">
							Hello, I'm Ebenezer Tiewei &#x1F44B;
						</h1>
						<p className="text-white text-[1.5rem] px-[1rem] lg:px-[20rem] lg:text-[2rem]">
							I'm a Frontend Developer with a passion for creating beautiful and
							functional web applications. I love to explore new technologies
