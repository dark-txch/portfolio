						...
						<nav className="relative text-white text-[1rem] w-screen shadow flex justify-between px-[1rem] uppercase border-[0.3rem] border-solid border-red-500 lg:flex lg:items-center lg:justify-between ">
							...
							<div className="flex gap-5">
								...
								<ul
									...
									} absolute bg-black flex flex-col gap-4 items-center pt-[1rem] pb-[2rem] left-0 right-0 transition-all duration-300 transform translate-y-10 opacity-100 border border-solid border-gray-500 lg:static lg:flex`}
								>
									<li className="hover:text-cyan-500 duration-500">
