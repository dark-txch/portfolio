...
export default function About() {
	return (
		<div className="w-screen h-auto bg-[#09063a] flex flex-col justify-center pb-[10rem] lg:flex-row">
			<div className="border-[0.2rem] border-cyan-100 lg:w-[70%] order-1">
				...
				<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.5rem] px-[1rem] mb-[2rem] lg:text-[2.2rem] lg:w-[50%] lg:mx-auto">
				...
				<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.5rem] px-[1rem] mb-[2rem] lg:text-[2.2rem] lg:w-[65%] lg:mx-auto">
				...
				<div className="flex justify-center mt-20 pb-[5rem] lg:w-[65%] lg:mx-auto">
					<a
						href=""
			...
			<div className="border-[0.2rem] border-cyan-100 lg:w-[20%] mt-[2rem] lg:mt-0 lg:pt-[5rem] lg:order-2">
