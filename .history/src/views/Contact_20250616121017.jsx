	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#33c9ff] font-tinos  leading-[2rem] px-[1rem] py-[5rem] text-cyan-400 lg:w-[80%] lg:mx-auto lg:my-[5rem] lg:py-[1rem] lg:flex lg:gap-[2rem] lg:text-[1.5rem]"
			>
				<div className="w-full flex text-[1.3rem] text-[#09063a] flex-col lg:justify-center pt-[2rem] lg:pt-0">
					<h1 className="text-[2.5rem] font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#09063a] to-[#33c9ff] ">
						Let's collaborate
					</h1>
					<p className="mb-[5rem]">
				...
				<div className="bg-[#1c1860] h-auto flex flex-col justify-between px-[2rem] pt-[5rem]  pb-[2rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:flex-row lg:gap-[4rem] lg:pb-[7rem]">
					<form
