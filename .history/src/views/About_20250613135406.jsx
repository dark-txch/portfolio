	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#09063a] text-[1.4rem] lg:text-[1.2rem] lg:px-[2rem] lg:bg-[#FFF4A4]"
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[1rem]">
					<div className="lg:w-full order-1">
						<h1 className=" font-bold text-cyan-400 leading-[3rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:text-[3rem]">
							Hello, I'm Ebenezer Tiewei &#x1F44B;
						</h1>
						<p className="font-thin text-white leading-[2.5rem] mb-[2rem]">
						...
						<p className="font-thin text-black leading-[2.5rem] mb-[2rem]">
						...
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
							...
							achive my clients goals, through my research, i became fascinated
