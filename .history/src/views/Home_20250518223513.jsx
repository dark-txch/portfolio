			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className="relative text-white text-[1rem] w-screen shadow flex justify-between px-[1rem] py-[1.5rem] uppercase border-[0.3rem] border-solid border-red-500 lg:flex lg:items-center lg:justify-between lg:pt-[2rem] ">
							...
							<div className="flex gap-5 lg:gap-[4rem]">
								...
								<ul
									className={`
										absolute bg-black flex flex-col gap-4 items-center pt-[1rem] pb-[2rem] 
										left-0 right-0 border border-solid border-gray-500 z-50
										transition-opacity duration-500 ease-out transform
										${isMenuOpen ? "opacity-100 translate-y-4" : "opacity-0 pointer-events-none"}
										
										// Hide on large screen (use horizontal nav instead)
										lg:static lg:flex lg:gap-[4rem] lg:flex-row lg:translate-y-0 lg:py-0
									`}
								>
									<li className="hover:text-cyan-500 duration-500">
						...
						{/* Body of the header */}
						<h1 className="text-white text-center mt-[2rem] text-[2rem]">
