				...
				<div className="border-[0.2rem] border-cyan-100 lg:w-[70%] order-1">
					...
					<div className="flex justify-center mt-20 pb-[5rem]">
						<a
							...
							aria-label="resume"
							className="inline-block uppercase text-cyan-200 text- border border-cyan-500 px-6 py-3 rounded-[10rem] hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-500"
						>
							Download my resume
						</a>
					</div>
