			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className="relative text-white text-[1rem] w-screen shadow flex  px-[1rem] uppercase border-[0.3rem] border-solid border-red-500 lg:flex lg:items-center lg:justify-between ">
							<ul>
