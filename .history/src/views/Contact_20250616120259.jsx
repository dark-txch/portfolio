	...
	return (
		<AnimatePresence mode="wait">
			...
			>
				...
				<div className="bg-[#1c1860] h-auto flex flex-col justify-between px-[2rem] pt-[5rem]  pb-[2rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:mx-auto lg:flex-row lg:gap-[4rem] pb-[2rem]">
					<form
