		...
		<>
			...
			>
				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] overflow-hidden lg:flex lg:justify-center lg:items-center">
					{/* EBENEZER container */}
					<div
						className={`relative w-screen h-[50dvh] flex flex-col justify-end items-center z-50 lg:h-[100vh] lg:flex lg:justify-center lg:w-[50vw] will-change-transform transition-all duration-500 ease-in-out z-20 ${
							slideOut
				...
				{/* <main className="-translate-y-[calc(100%-8rem)] lg:-translate-y-full "> */}
				<main className="relative top-[-40rem] lg:top-[-50rem]">
