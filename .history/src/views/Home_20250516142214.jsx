		...
		<>
			...
			>
				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] overflow-hidden lg:flex lg:justify-center lg:items-center">
					{/* EBENEZER container */}
					<div
						className={`relative w-screen h-[50dvh] flex flex-col justify-end items-center transition-all duration-500 ease-in-out z-20 ${
							slideOut ? "-translate-y-full" : "fixed top-0 left-0"
						} lg:relative lg:h-[100vh] lg:w-[50vw] lg:justify-center lg:translate-x-0`}
					>
						<BackgroundVideo
							src="/video/gym-s.mp4"
					...
					{/* TIEWIE container */}
					<div
						className={`relative w-screen h-[50dvh] flex flex-col justify-start items-center transition-all duration-500 ease-in-out z-20 ${
							slideOut ? "translate-y-full" : "fixed bottom-0 left-0"
						} lg:relative lg:h-[100vh] lg:w-[50vw] lg:justify-center lg:translate-x-0`}
					>
						<BackgroundVideo
