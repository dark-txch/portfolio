			...
			<div className="flex flex-col justify-center lg:flex-row">
				<div className="border-[0.2rem] border-cyan-100 lg:w-[70%] order-1">
					...
					<div className="flex justify-center mt-20 pb-[5rem]">
						<a
							href="https://docs.google.com/document/d/1IrEwV7yAk8BnJbFFMpIwr2gZ8mIreHamtIgr1XtB6P0/edit?usp=sharing"
							https:target="_blank" //docs.google.com/document/d/1IrEwV7yAk8BnJbFFMpIwr2gZ8mIreHamtIgr1XtB6P0/view
