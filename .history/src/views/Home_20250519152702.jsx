	...
	return (
		<>
			...
			>
				...
				<main className="-translate-y-{200%} lg:-translate-y-[150%] ">
					<header className="w-screen h-auto bg-[#0C0950] pt-[20rem] lg:pt-[40rem]">
						...
						{/* Body of the header */}
						<h1 className="font-unna text-cyan-200 px-[1rem] leading-[3rem] mt-[7rem] text-[2.5rem] mb-[0.8rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
