	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#33c9ff] font-unna font-thin leading-[2.5rem] text-[1.9rem] text-[#4B164C] lg:text-[1.5rem] lg:px-[2rem] lg:bg-[#33c9ff]"
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[5rem]">
					<div className="lg:w-full order-1">
						...
						<p className="mb-[1rem]">
							...
							achieve my client goals.
						</p>
						<p className="mb-[1rem]">
							Through my research, i became fascinated with the world of software
							development, i was intrigued by the idea of creating something
							from nothing, giving it life and color to make it beautiful and
							responisive, this new fascination got me doing more research that
							was at first overwelming when finding out about the amount of
							technical skills required to be very good at it, but i am not the
							type to shy away from challenges, i just have to prepare my mind
							for it and like the Nike slogan{" "}
