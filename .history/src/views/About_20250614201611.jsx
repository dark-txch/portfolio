			...
			>
				...
				<div className="flex justify-center mt-20 pb-[10rem]">
					<a
						...
						className="inline-block uppercase text-cyan-200 hover:font-bold bg-[#09063a] border shadow-deep border-cyan-500 text-base px-6 py-3 rounded-full hover:bg-[#33c9ff] hover:text-[#0C0950]  transition-all duration-500"
					>
						Download my resume
					</a>
				</div>
