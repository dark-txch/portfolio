...
export default function Contact() {
	...
	return (
		<div className="bg-[#1c1860] w-[80%] h-auto mx-auto flex flex-col justify-between border-[0.1px] border-cyan-200 mt-[5rem] mb-[10rem] px-[1rem] lg:flex-row  lg:py-[5rem]">
