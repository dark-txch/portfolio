			...
			>
				<div className="bg-[#1c1860] h-auto flex flex-col justify-between mx-[1rem] px-[1rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:mx-auto lg:flex-row lg:gap-[4rem]  lg:py-[5rem] lg:px-[2rem]">
					...
					>
						...
						<button
							type="submit"
							className="w-full uppercase border text-[1rem] px-6 py-3 rounded-[1rem] text-cyan-200 border-cyan-500 shadow-light hover:bg-cyan-500 hover:font-bold hover:text-[#0C0950] transition-all duration-500 bg-[#92e2ff]"
						>
							Send Message
						</button>
						{statusMessage && (
