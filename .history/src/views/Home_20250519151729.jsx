			...
			>
				...
				<main className="-translate-y-full mt-[20rem]">
					<header className="w-screen h-auto bg-[#0C0950]">
						<nav className="relative text-[1rem] w-screen shadow flex justify-between m px-[1rem] py-[1.5rem] uppercase lg:flex lg:items-center lg:justify-between lg:px-[3rem] border border-red-500">
