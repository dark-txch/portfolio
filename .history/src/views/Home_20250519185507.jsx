		...
		<>
			...
			>
				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] overflow-hidden lg:flex lg:justify-center lg:items-center">
					{/* EBENEZER container */}
					<div
						className={`relative w-screen h-[50dvh] flex flex-col justify-end items-center z-50 lg:h-[100vh] lg:flex lg:justify-center lg:w-[50vw] will-change-transform transition-all duration-1000 ease-in-out ${
							slideOut
					...
					{/* TIEWEI container */}
					<div
						className={`relative w-screen h-[50dvh] flex flex-col justify-start items-center lg:h-[100vh] lg:flex lg:justify-center lg:w-[50vw] will-change-transform transition-all duration-1000 ease-in-out z-20 ${
							slideOut
								? "translate-y-[200%] lg:-translate-y-0 lg:translate-x-full"
								: ""
						}`}
				...
				<main
					className={`absolute top-0 left-0 w-full h-full z-40 transition-all duration-1000 ease-in-out ${
						mainSlideUp
							? "translate-y-0 opacity-100"
							: "translate-y-full opacity-0"
					}`}
				>
					<header className="w-screen h-auto bg-[#0C0950] pt-[5rem]">
						<nav className="relative text-[1rem] w-screen shadow h-[6rem] flex justify-between items-center px-[1rem] uppercase lg:flex lg:items-center lg:justify-between lg:px-[3rem] border border-red-500">
						...
						{/* Body of the header */}
						<h1 className="font-unna text-cyan-200 px-[1rem] leading-[3rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
							Hello, I'm Ebenezer Tiewei &#x1F44B;
						</h1>
						<p className="font-unna text-[#EAE4D5] text-[1.8rem] leading-[2.2rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
							I’m a Frontend Developer with a strong passion for building
							elegant, user-centered web applications.
						</p>
						<p className="font-unna text-[#EAE4D5] text-[1.8rem] leading-[2.2rem] px-[1rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
