			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						...
						<p className="font-unna text-[#EAE4D5] text-[1.8rem] leading-[2.3rem] px-[1rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
							I’m a Frontend Developer with a strong passion for building
							elegant, user-centered web applications.
						</p>
						<p className="font-unna text-[#EAE4D5] text-[1.8rem] leading-[2.35rem] px-[1rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
