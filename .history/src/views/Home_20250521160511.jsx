...
export default function Home() {
	return (
		<>
			<main className="w-screen h-auto bg-[#09063a] text-[1.4rem] flex flex-col justify-center pb-[10rem]">
				...
				<p className="font-thin text-[#EAE4D5] leading-[2.5rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
					I’m a Frontend Developer with a strong passion for building elegant,
					user-centered web applications.
				</p>
				<p className="font-thin text-[#EAE4D5] leading-[2.5rem] px-[1rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
				...
				<div className="flex justify-center mt-20 lg:w-[65%] lg:mx-auto">
					<Link
						to="/about"
						className="inline-block uppercase text-[1.2rem] text-cyan-200 border border-cyan-500 px-6 py-3 rounded-[10rem] hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-500"
					>
						More about me
					</Link>
				</div>
