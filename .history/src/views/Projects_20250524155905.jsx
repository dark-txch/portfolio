		...
		<div className=" w-screen h-auto flex flex-col px-[1rem] pt-[5rem] pb-[10rem]  border">
			<div className="bg-[#1c1860] w-full mx-auto p-[1rem] flex flex-col items-center border">
				...
				<div className=" w-full">
					...
					<div>
						<button onClick={() => setProjectPortfolio(!projectPortfolio)} className="uppercase flex gap-3 items-center text-cyan-200 text-[1rem]">
							{pro<FaHandPointDown /> : <FaHandPointRight /> }
							details
						</button>
					</div>
					<div>
