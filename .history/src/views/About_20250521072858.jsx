...
export default function About() {
	return (
		<div className="w-screen h-auto bg-[#09063a] flex flex-row justify-center pb-[10rem]">
			<div className="border-[0.2rem] border-cyan-100 lg:w-[80%]">
				...
				<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.5rem] px-[1rem] mb-[2rem] lg:text-[2.2rem] lg:mx-auto">
				...
				<div className="flex justify-center mt-20 lg:mx-auto">
					<a
						href=""
