			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						...
						{/* Body of the header */}
						<h1 className="font-unna text-cyan-200 text-center mt-[4rem] text-[3rem] mb-[1.5rem]">
							Hello, I'm Ebenezer Tiewei &#x1F44B;
						</h1>
						<p className="font-unna text-[EAE4D5]-500 text-[1.8rem] px-[1rem] lg:w-[60%] lg:text-[2.2rem] lg:mx-auto text-center">
