			...
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[1rem]">
					<div className="lg:w-full order-1">
						...
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
							Growing up, the world around me was lonely and dull, i struggled to fit in, making friends came easy for me but keeping them was a challenge, although i enjoy my own company and often play chess with myself, i soon realized that i needed to find a way to connect with others and football was my escape, it was a way for me to  connect with others and keep the connection since we had a common interest, and to stay fit to play football, i had to get 
						</p>
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
