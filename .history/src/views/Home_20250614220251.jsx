		...
		<AnimatePresence mode="wait">
			...
			>
				...
				<p className="mb-[1rem] lg:w-[65%] lg:mx-auto">
					Frontend Developer who is highly self-motivated, disciplined, and
					filled with a growing passion for building clean, responsive, and
					user-friendly web interfaces. I enjoy working in a team as much as I
