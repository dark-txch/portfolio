		...
		<div className="w-screen h-auto bg-[#09063a] text-[1.4rem] pb-[5rem] lg:text-[1.6rem] lg:px-[3rem]">
			...
			<div className="text-[#EAE4D5] mt-10">
				<button
					...
					className="uppercaseflex gap-3 items-center text-cyan-200 text-[1rem] px-6 py-2 rounded-full hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-300"
				>
