	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#33c9ff] font-tinos  leading-[2.5rem] text-[1.7rem] text-[#4B164C] lg:text-[1.5rem] lg:px-[2rem] lg:bg-[#33c9ff]"
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[5rem]">
					<div className="lg:w-full order-1">
						...
						<p className="mb-[1rem]">
							Throughout my journey as a fitness instructor and personal trainer, I
