	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#33c9ff] font-tinos  leading-[2rem] py-[5rem] text-cyan-400 lg:text-[1.5rem]"
			>
				<div className="w-full flex text-[#09063a] text-[1.3rem]  bg-gradient-to-br from-green-300 to-blue-500 bg-clip-text text-transparent flex-col lg:justify-center pt-[2rem] lg:pt-0">
					<h1 className="font-unna font-bold leading-[2.5rem] mt-[5rem] text-[2.5rem] text-cyan-300 mb-[1.5rem] lg:text-[3rem]">
						Let's collaborate
					</h1>
					<p className="mb-[5rem]">
				...
				<div className="bg-[#1c1860] h-auto flex flex-col justify-between mx-[0.5rem] px-[2rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:mx-auto lg:flex-row lg:gap-[4rem]  lg:py-[5rem] lg:px-[2rem]">
					<form
