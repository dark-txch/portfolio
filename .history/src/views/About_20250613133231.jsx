	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#09063a] text-[1.4rem] lg:text-[1.4rem] lg:px-[2rem]"
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[1rem]">
					<div className="lg:w-full order-1">
						...
						<p className="font-thin text-[] leading-[2.5rem] mb-[2rem]">
						...
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
							So what do i enjoy about software development? I love the magic and the impact the magic can have in our lives
						</p>
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
