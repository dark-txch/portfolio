	...
	return (
		<div className="bg-[#1c1860] h-auto flex flex-col justify-between mx-[1rem] mt-[5rem] mb-[10rem] px-[1rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:mx-auto lg:flex-row lg:gap-[4rem]  lg:py-[5rem] lg:px-[2rem]">
			...
			>
				...
				<button
					type="submit"
					className="w-full uppercase text-cyan-200 border border-cyan-500 text-[1rem] px-6 py-3 rounded-[10rem] hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-500"
				>
					Send Message
				</button>
			</form>
