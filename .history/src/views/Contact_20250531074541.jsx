		...
		<AnimatePresence mode="wait">
			...
			>
				...
				>
					...
					<button
						type="submit"
						className="w-full uppercase border text-[1rem] px-6 py-3 rounded-[1rem] text-cyan-200 border-cyan-500 sh hover:bg-cyan-500 hover:font-bold hover:text-[#0C0950] transition-all duration-500"
					>
						Send Message
					</button>
					{statusMessage && (
