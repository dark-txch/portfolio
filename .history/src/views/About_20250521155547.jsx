		...
		<div className="w-screen h-auto bg-[#09063a] lg:px-[3rem]">
			...
			<div className="text-[#EAE4D5] px-4 mt-10">
				<button
					...
					className="uppercase border border-cyan-500 text-cyan-200 px-6 py-2 rounded-full hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-300"
				>
					https://react-icons.github.io/react-icons/search/#q=pointSkills
				</button>
