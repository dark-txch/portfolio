...
export default function About() {
	...
	return (
		<div className="w-screen h-auto bg-[#09063a] text-[1.4rem] pb-[5rem] lg:text-[2.2rem] lg:px-[3rem]">
			<div className="flex flex-col justify-center lg:flex-row">
				<div className="border-[0.2rem] border-cyan-100 lg:w-[70%] order-1">
					...
					<p className="font-thin text-[#EAE4D5] leading-[2.5rem] px-[1rem] mb-[2rem] lg:text-[2.2rem]">
