...
//  Portfolio Project--------------------------------
import MacboookPortfolio from "../assets/Projects/porfolio/";
import ipadPortfolio from "../assets/Projects/portfolio/iPadPortfolio.webp";
import iPhonePortfolio from "../assets/Projects/portfolio/iPhonePortfolio.webp";
...
const projects = [
	...
	// Portfolio Project-----------------------------------
	{
		...
		summary: "My personal portfolio website showcasing my skills and projects.",
		tools: ["Vite", "React", "Tailwind CSS", "Git"],
		view: "https://ebenezer-tiewei-portfolio.netlify.app/",
	},
];
