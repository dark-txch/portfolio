...
export default function Home() {
	return (
		<>
			<main className="w-screen h-auto bg-[#09063a] text-[1.4rem] flex flex-col justify-center lg:text-[1.6rem]">
				...
				<div className="flex justify-center w-screen mx-auto mt-20 mb-[10] lg:w-[65%] lg:mx-auto">
					<Link
						to="/about"
