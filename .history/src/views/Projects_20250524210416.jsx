	...
	return (
		<div className=" w-screen h-auto flex flex-col px-[1rem] pt-[5rem] pb-[10rem]">
			<div className="border lg:w-[50%]">
				<div className="bg-[#1c1860] w-full flex flex-col items-center border-[0.5rem] border-[#6DE1D2] rounded-bl-[3rem]">
					...
					<div className=" w-full bg-[#000000] rounded-bl-[5rem]">
									...
									>
										{portfolioSummary.map((category) => (
											<div
												...
												className="pl-[2.8rem] pr-[1rem] border-b-[0.1px] rounded-bl-[5rem] border-cyan-500 pt-2 pb-2"
											>
