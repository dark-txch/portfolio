			...
			>
				...
				<div className="flex justify-center mt-20 pb-[10rem]">
					<a
						...
						className="inline-block uppercase text-cyan-200 border shadow-deep border-[#09063a] text-base px-6 py-3 rounded-full hover:bg-cyan-500 hover:text-[#0C0950] hover:font-bold transition-all duration-500"
					>
						Download my resume
					</a>
				</div>
