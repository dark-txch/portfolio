...
import King from "../assets/About/King.webp";
	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#33c9ff] font-tinos  leading-[2rem] text-[1.7rem] text-[#09063a] lg:text-[1.5rem] lg:px-[2rem]"
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[5rem]">
					<div className="lg:w-full order-1">
						<h1 className="font-unna font-bold leading-[2.5rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:text-[3rem]">
						...
						<h6 className="mt-[2rem] mb-[0.5rem] font-unna font-bold">
				...
				<div className="text-[#09063a] mt-10 px-[1rem]">
					<button
						...
						className="uppercase font-bold font-unna flex gap-3 items-center text-[1.5rem]"
					>
						{showSkills ? (
							<FaHandPointRight />
						) : (
							...
							>
								{skillCategories.map((category) => (
									...
									>
										...
										<ul className="text-[1.2rem] flex gap-3 items-center">
				...
				<div className=" w-full flex justify-center py-[5rem]">
					<a
						...
						href="https://docs.google.com/document/d/1Yy5hnoUfNJudXfDZjr4CW6ugIVcJaxIYl-nhSmbubBM/v"
						target="_blank"
