import MacbookBizpadi from "../assets/Projects/bizpadi/MacbookBizpadi.png";
import ipadBizpadi from "../assets/Projects/bizpadi/IpadBizpadi.png";
import IphoneBizpadi from "../assets/Projects/bizpadi/IphoneBizpadi.png";
		...
		<div className=" w-screen h-auto flex flex-col px-[1rem] pt-[5rem] pb-[10rem]">
			<div className="lg:w-[50%]">
				<div className="bg-[#1c1860] w-full flex flex-col items-center border-[0.5rem] border-[#6DE1D2] rounded-[3rem]">
					...
					<div className=" w-full bg-[#000000] rounded-bl-[3rem] rounded-br-[3rem]">
