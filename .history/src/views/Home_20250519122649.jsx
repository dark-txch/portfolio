			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className="relative text- text-[1rem] w-screen shadow flex justify-between px-[1rem] py-[1.5rem] uppercase lg:flex lg:items-center lg:justify-between lg:pt-[2rem] lg:px-[3rem]">
