			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						...
						{/* Body of the header */}
						<h1 className="font-patrick text-cyan-300 text-center mt-[4rem] text-[2.5rem] mb-[1.5rem]">
							Hello, I'm Ebenezer Tiewei &#x1F44B;
						</h1>
						<p className="font-patrick text-cyan-500 text-[1.5rem] px-[1rem] lg:px-[20rem] lg:text-[2rem]">
							I'm a Frontend Developer with a passion for creating beautiful and
							functional web applications. I started my journey in web
							development on the 17th of May 2024 I love to explore new
