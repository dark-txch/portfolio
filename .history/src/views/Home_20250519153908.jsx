	...
	return (
		<>
			...
			>
				...
				<main className="translate-y-[-80%] lg:translate-y-[-150%]">
					<header className="w-screen h-auto bg-[#0C0950] pt-[5rem]">
						...
						<p className="font-unna text-[#EAE4D5] text-[1.8rem] leading-[3rem] px-[1rem] mb-[1.5rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
