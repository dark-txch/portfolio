	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#09063a] text-[1.4rem] lg:text-[1.4rem] lg:px-[2rem] lg:bg-[#f0ebc4]"
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[1rem]">
					<div className="lg:w-full order-1">
						<h1 className="font-unna font-bold text-[] leading-[3rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:text-[3rem]">
						...
						<p className="font-unna font-thin text-black leading-[2.5rem] mb-[2rem]">
							...
							soon took it on prefessionally and became a fitness instructor and personal trainer.
						</p>
