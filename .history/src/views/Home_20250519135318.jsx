			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						...
						{/* Body of the header */}
						<h1 className="font-unna text-cyan-200 px-[1rem]  mt-[4rem] text-[2.5rem] mb-[1.5rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
							Hello, I'm Ebenezer Tiewei &#x1F44B;
						</h1>
						<p className="font-unna text-[#EAE4D5] text-[1.8rem] px-[1rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
							I’m a Frontend Developer with a strong passion for building
							elegant, user-centered web applications.
						</p>
						<p className="font-unna text-[#EAE4D5] text-[1.8rem] px-[1rem] lg:w-[60%] lg:text-[2.2rem] lg:mx-auto">
