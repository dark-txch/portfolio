			...
			>
				...
				<main className="-translate-y-[calc(100%-8rem)] lg:-translate-y-[calc(200%-8rem)]">
					<header className="w-screen h-auto bg-[#0C0950]">
						<nav className="relative text-[1rem] w-screen shadow flex justify-between translate-y-[2rem] px-[1rem] py-[1.5rem] uppercase lg:flex lg:items-center lg:justify-between lg:top-[2rem] lg:px-[3rem] border border-red-500">
