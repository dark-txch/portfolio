			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className=" text-white text-[1rem] w-screen h-[7rem] shadow-lg flex items-center justify-center border-[0.3rem] border-solid border-red-500 ">
							<ul>
							...
							<ul className="flex gap-8 text-lg">
								...
								<li className="hover:text-cyan-500 duration-500"></li>
								<li className="hover:text-cyan-500 duration-500"></li>
								<li className="hover:text-cyan-500 duration-500"></li>
								<li className="hover:text-cyan-500 duration-500"></li>
