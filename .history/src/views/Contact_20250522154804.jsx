...
export default function Contact() {
	...
	return (
		<div className="bg-[#1c1860] w-[80%] h-auto mx-auto flex flex-col justify-between mt-[5rem] mb-[10rem] px-[2rem] rounded-tl-[3rem] rounded-tl-[3rem]  lg:flex-row lg:gap-[4rem]  lg:py-[5rem]">
