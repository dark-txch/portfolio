	...
	return (
		<>
			...
			>
				...
				<main className="-translate-y-[calc(100%-8rem)] lg:-translate-y-[calc(200%-8rem)]">
					<header className="w-screen h-auto bg-[#0C0950]">
						<nav className="relative text-[1rem] w-screen shadow flex justify-between translate-y-[1rem] px-[1rem] py-[1.5rem] uppercase lg:flex lg:items-center lg:justify-between lg:translate-y-[2rem] lg:px-[3rem] border border-red-500">
						...
						{/* Body of the header */}
						<h1 className="font-unna text-cyan-200 px-[1rem] leading-[3rem] pt-[4rem] text-[2.5rem] mb-[0.8rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
