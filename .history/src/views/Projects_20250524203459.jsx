...
export default function Projects() {
	...
	return (
		<div className=" w-screen h-auto flex flex-col px-[1rem] pt-[5rem] pb-[10rem]">
			<div className=bg-[#1c1860] w-full flex flex-col items-center border-[0.5rem] border-[#6DE1D2] 
             lg:w-[50%] rounded-xl shadow-2xl transition-transform duration-500 ease-in-out 
             hover:rotate-x-[6deg] hover:rotate-y-[4deg] hover:scale-[1.02] perspective-[1200px]>
