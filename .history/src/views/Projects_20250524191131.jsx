...
export default function Projects() {
	...
	return (
		<div className=" w-screen h-auto flex flex-col px-[1rem] pt-[5rem] pb-[10rem]  border">
			<div className="bg-[#18603a] w-full mx-auto p-[1rem] flex flex-col items-center border lg:w-[50%]">
				<div className="bg-[#1DCD9F] w-full h-[18rem] border flex justify-between p-[1rem] mb-[1rem] lg:w-[50%] lg:space-x-5">
					<img
						src={IphonePortfolio}
						alt="IphonePortfolio"
