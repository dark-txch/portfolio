				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] overflow-hidden lg:flex lg:justify-center lg:items-center">
					...
					>
						...
						<div className="relative flex justify-between items-end w-full px-[1rem] overflow-hidden lg:flex lg:flex-col lg:items-end lg:px-0">
							<h1 className="text-[#60B5FF] text-[1.5rem] uppercase font-bold w-[7rem] pb-[0.5rem] lg:w-[15rem] lg:pr-[1rem] lg:text-right lg:text-[1.5rem] lg:order-5">
								Ebenezer
							</h1>
							...
							<h4 className="text-[1.5rem] text-[#60B5FF] font-bold text-right pr-[0.6rem] uppercase w-[7rem] pb-[0.5rem] lg:w-[15rem] lg:pl-[1rem] lg:text-[2.5rem] lg:order-4">
								Frontend
							</h4>
						</div>
					</div>
					...
					>
						...
						<div className="relative flex justify-between items-start w-full px-[1rem] overflow-hidden lg:flex lg:flex-col lg:items-start lg:px-0">
							<h1 className="text-[#60B5FF] text-[1.5rem] font-bold uppercase w-[7rem] pt-[0.5rem] lg:pt-0 lg:pb-[0.5rem] lg:w-[15rem] lg:pl-[1rem] lg:text-[1.5rem] lg:order-5">
								Tiewei
							</h1>
							...
							<h4 className="text-[1.5rem] text-[#60B5FF] font-bold text-right pr-[0.3rem] uppercase w-[7rem] pt-[0.5rem] lg:text-left lg:pb-[0.5rem] lg:pt-0 lg:w-[15rem] lg:pl-[1rem] lg:text-[2.5rem] lg:order-4">
								Developer
							</h4>
						</div>
					</div>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						...
						<p className="text-white text-[1.5rem] px-[1rem] lg:px-[20rem] lg:text-[2rem]">
							...
							I started my journey in web development on the 17th of May 2024 
