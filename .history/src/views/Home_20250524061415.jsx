...
export default function Home() {
	return (
		<>
			<main className="w-screen h-auto bg-[#09063a] text-[1.4rem] flex flex-col justify-center pt-[10rem] pb-[10rem] lg:text-[1.6rem]">
				<h1 className="font-unna font-bold text-cyan-200 px-[1rem] leading-[3rem] text-[2.5rem] mb-[1.5rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
