			...
			<div className="flex flex-col justify-center lg:flex-row">
				<div className="border-[0.2rem] border-cyan-100 lg:w-[70%] order-1">
					...
					<div className="flex justify-center mt-20 pb-[5rem]">
						<a
							href="https://drive.google.com/file/d/1t48PBpGTgwhCVGRCfzxmX58-07M0iydG/view?usp=sharinghttps://drive.google.com/file/d/1g5JoXm872eN5ZZWBeZ2LOUSYTQgfJiI4/view?usp=sharing"
							target="_blank"
