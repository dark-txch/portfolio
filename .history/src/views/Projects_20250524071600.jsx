	...
	return (
		<div className=" w-screen h-auto flex flex-col px-[1rem] pt-[5rem] pb-[10rem]  border">
			<div className="bg-[#1c1860] w-full mx-auto p-[1rem] flex flex-col items-center border md:flex-row lg:flex-row">
				<div className="bg-[#FF90BB] w-full h-[18rem] border flex justify-center space-x-2 p-[1rem]">
					<img
						src={IphonePortfolio}
						alt="IphonePortfolio"
				...
				<div className=" w-full">
					<h4 className="font-unna font-bold  text-[1.5rem] text-center text-cyan-200 underline decoration-dashed mb-">
						portfolio
					</h4>
					<div>
