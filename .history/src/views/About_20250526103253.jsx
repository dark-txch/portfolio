...
export default function About() {
	...
	return (
		<AnimatePresence mode="wait">
				<motion.div className="w-screen h-auto bg-[#09063a] text-[1.4rem] lg:text-[1.6rem] lg:px-[3rem]">
					<div className="flex flex-col justify-center lg:flex-row">
						<div className="lg:w-[70%] order-1">
							...
							<p className="font-thin text-[#EAE4D5] leading-[2.5rem] px-[1rem] mb-[2rem]">
								My journey started at AltSchool Africa, where I immersed myself
								in the world of web development. I quickly discovered my passion
								for building visually pleasing and user-friendly web
								applications. I have developed a strong interest in responsive
							...
							<p className="font-thin text-[#EAE4D5] leading-[2.5rem] px-[1rem] mb-[2rem]">
								...
								software development and to become a proficient software
								engineer.
							</p>
							<p className="font-thin text-[#EAE4D5] leading-[2.5rem] px-[1rem] mb-[2rem]">
							...
							<p className="font-thin text-[#EAE4D5] leading-[2.5rem] px-[1rem] mb-[2rem]">
								...
								contribute to the development of innovative web applications and
