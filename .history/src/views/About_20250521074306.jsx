...
export default function About() {
	return (
		<div className="w-screen h-auto bg-[#09063a] flex flex-col justify-center pb-[10rem]">
			<div className="border-[0.2rem] border-cyan-100 lg:w-[70%] ord">
			...
			<div className="border-[0.2rem] border-cyan-100 lg:w-[20%] mt-[2rem]">
