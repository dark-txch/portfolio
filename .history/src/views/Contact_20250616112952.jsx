...
export default function Contact() {
	...
	return (
		<AnimatePresence mode="wait">
			...
			>
				<div className="w-full flex  text-[1.3rem]  bg-gradient-to-br from-green-300 to-blue-500 bg-clip-text text-transparent flex-col lg:justify-center pt-[2rem] lg:pt-0">
