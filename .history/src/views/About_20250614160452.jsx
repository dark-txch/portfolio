		...
		<AnimatePresence mode="wait">
			...
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[5rem]">
					...
					<div className="mt-[5rem] lg:w-[40rem] lg:h-[40rem] lg:mt-[10rem] lg:order-2 md:flex md:justify-center ">
						<img
							src={EbenezerPortfolioOptimized}
							loading="lazy"
							alt="Ebenezer seated at his work desk in a modern office"
							className="rounded-[2rem] w-full h-full object-cover border-[2px] border"
						/>
					</div>
				</div>
