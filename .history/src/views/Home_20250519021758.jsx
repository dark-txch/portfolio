			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className="relative text-white text-[1rem] w-screen shadow flex justify-between px-[1rem] py-[1.5rem] uppercase lg:flex lg:items-center lg:justify-between lg:pt-[2rem] ">
							...
							<div className="flex gap-5 lg:gap-[4rem]">
								...
								<ul
									className={`absolute bg-[#0C0950] flex flex-col gap-4 items-center pt-[1rem] pb-[2rem] left-0 right-0 z-50
										lg:static lg:flex lg:gap-[4rem] lg:flex-row lg:translate-y-0 lg:py-0
										${
											isMenuOpen
												? "transition-all duration-700 ease-out opacity-100 translate-y-14"
						...
						<p className="text-white text-[1.5rem] px-[1rem]">
