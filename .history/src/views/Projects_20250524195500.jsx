...
export default function Projects() {
	...
	const portfolioSummary = [
		{
			summary:
				"My personal portfolio website built to showcase my frontend projects, skills, and contact information. It is fully responsive and built with modern tools, and includes interactive UI elements.",
	...
	return (
		<div className=" w-screen h-auto flex flex-col px-[1rem] pt-[5rem] pb-[10rem]  border">
			<div className="bg-[#1c1860] w-full flex flex-col items-center border lg:w-[50%]">
				<div className="bg-[#1c1860] w-full h-[18rem] border flex justify-between p-[1rem] lg:space-x-5 lg:h-[14rem]">
					<img
						src={IphonePortfolio}
						alt="IphonePortfolio"
				...
				<div className=" w-full">
					<div className="text-[#EAE4D5] border w-full">
						<button
										...
										>
											...
											<ul className="flex flex-wrap gap-4">
												{category.tools.map((tool) => (
													<li
														key={tool}
														className="flex items-center gap-2 text-sm bg-[#1e1e1e] px-3 py-1 rounded-full"
													>
