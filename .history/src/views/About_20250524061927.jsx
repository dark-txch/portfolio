		...
		<div className="w-screen h-auto bg-[#09063a] text-[1.4rem] lg:text-[1.6rem] lg:px-[3rem]">
			...
			<div className="flex justify-center mt-20 pb-[5rem]">
				<a
					...
					aria-label="resume"
					className="inline-block uppercase text-cyan-200 border border-cyan-500 text-[1rem] px-6  rounded-[10rem] hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-500"
				>
					Download my resume
				</a>
			</div>
