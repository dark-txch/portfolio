			...
			>
				...
				<main className="-translate-y-[calc(100%-8rem)] lg:-translate-y-[calc(200%-8rem)]">
					<header className="w-screen h-auto bg-[#0C0950]">
						<nav className="relative text-[1rem] w-screen shadow flex justify-between px-[1rem] py-[2rem] uppercase lg:flex lg:items-center lg:justify-between lg:pt-[2rem] lg:px-[3rem]">
