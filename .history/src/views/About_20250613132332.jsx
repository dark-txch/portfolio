				...
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[1rem]">
					<div className="lg:w-full order-1">
						...
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
							...
							soon took it on prefessionally and as a short term career, i
							became a fitness instructor and personal trainer.
						</p>
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
							Throughout my time as a fitness instructor and personal trainer, I did lots of research to improve on myself has a trainer and to achive my clients goals, through my research, i became fascinated with the world of software development, i was intrigued by the idea of creating something from nothing, giving it life and color to make it beautiful  and responisive, this new fascination got me doing more research that was at first overwelming when finding out about the amount of technical skills required to be very good at it, but i am not the type to shy away from challenges, i just have to prepare my mind for it and like the Nike slogan <span>"Just do it"</span>
						</p>
