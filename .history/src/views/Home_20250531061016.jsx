	...
	return (
		<AnimatePresence mode="wait">
			<motion.main
				...
				className="w-screen h-auto bg-[#2bc0e5] text-[1.4rem] flex flex-col justify-center lg:text-[1.6rem]"
			>
				<h1 className="font-unna font-bold text-[#4300FF] px-[1rem] leading-[3rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
					Hello, I'm Ebenezer Tiewei &#x1F44B;
				</h1>
				<p className="font-thin text-[#4300FF] leading-[2.5rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:mx-auto">
