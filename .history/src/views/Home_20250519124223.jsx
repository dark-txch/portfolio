			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						...
						<p className="font-patrick text-cyan-500 text-[1.5rem] px-[1rem] lg:w-[60%] lg:text-[2rem] lg:mx-auto">
							...
							development on the 17th of May 2024 and ever since i noted i have a love for
							esponsive design, accessibility and pleasing aesthetics.
						</p>
					</header>
				</main>
			</div>
