			...
			>
				...
				<main className="">
					<header className="w-screen h-auto bg-[#0C0950] pt-[5rem]">
						<nav className="relative text-[1rem] w-screen shadow  flex justify-between px-[1rem] uppercase lg:flex lg:items-center lg:justify-between lg:px-[3rem] border border-red-500">
