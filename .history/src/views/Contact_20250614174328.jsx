	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#33c9ff] font-tinos  leading-[2rem]"
			>
				<div className="bg-[#1c1860] h-auto flex flex-col justify-between mx-[1rem] mt-[5rem] mb-[10rem] px-[1rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:mx-auto lg:flex-row lg:gap-[4rem]  lg:py-[5rem] lg:px-[2rem]">
					<div className="w-full flex flex-col lg:justify-center pt-[2rem] lg:pt-0">
						<h1 className="font-unna font-bold  text-[2.5rem] text-cyan-400">
							Let's collaborate
						</h1>
						<p className="font-thin text-cyan-500 text-[1.4rem] leading-[2.5rem] mb-[2rem]">
