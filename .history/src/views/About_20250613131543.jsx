			...
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[1rem]">
					<div className="lg:w-full order-1">
						...
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
							Throughout my time as a fitness instructor and personal trainer, I did lots of research to improve on myself has a trainer and to achive my clients goals, through my research, i became fascinated with the world of software development, i was intrigued by the idea of creating something from nothing, and the ability to solve problems through code. I realized that software development was a way for me to connect with others on a deeper level, and to create something that could have a positive impact on people's lives.
						</p>
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
