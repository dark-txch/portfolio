...
export default function Projects() {
	...
	return (
		<div className=" w-screen h-auto flex flex-col px-[1rem] pt-[5rem] pb-[10rem]  border">
			<div className="bg-[#18603a] w-full p-[1rem] flex flex-col items-center border lg:w-[50%]">
				<div className="bg-[#1DCD9F] w-full h-[18rem] border flex justify-between p-[1rem] mb-[0.3rem] lg:space-x-5 lg:h-[14rem]">
					<img
						src={IphonePortfolio}
						alt="IphonePortfolio"
				...
				<div className=" w-full">
					<div className="text-[#EAE4D5] mt-10 px-[1rem] border w-full">
						<button
