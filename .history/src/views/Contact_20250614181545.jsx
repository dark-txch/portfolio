					...
					>
						<div>
							...
							<input
								...
								className="w-full px-4 py-2 border border-cyan-300 rounded-[1rem] text-[#EAE4D5] text-[1.2rem]"
								value={formData.name}
						...
						<div>
							...
							<input
								...
								className="w-full px-4 py-2 border border-cyan-300 rounded-[1rem] text-[#EAE4D5] ext-[1.2rem]"
