...
export default function About() {
	return (
		<div className="w-screen h-auto bg-[#09063a] flex flex-row justify-center pb-[10rem]">
			<div className="border-[0.2rem] border-cyan-100 lg:w-[70%]">
				<h1 className="font-unna font-bold text-cyan-200 px-[1rem] leading-[3rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:w-[60%] lg:mx-auto lg:text-[3rem]">
					Hello, I'm Ebenezer Tiewei &#x1F44B;
				</h1>
				<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.5rem] px-[1rem] mb-[2rem] lg:text-[2.2rem] lg:w-[60%] lg:mx-auto">
			...
			<div className="border-[0.2rem] border-cyan-100 lg:w-[20%]">
