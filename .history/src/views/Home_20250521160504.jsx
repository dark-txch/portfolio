		...
		<>
			<main className="w-screen h-auto bg-[#09063a] text-[1.4rem] flex flex-col justify-center pb-[10rem]">
				...
				<div className="flex justify-center mt-20 lg:w-[65%] lg:mx-auto">
					<Link
						to="/about"
						className="inline-block uppercase text-[1.4rem] text-cyan-200 border border-cyan-500 px-6 py-3 rounded-[10rem] hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-500"
					>
						More about me
					</Link>
				</div>
