		...
		<>
			...
			>
				...
				>
					...
					{/* Body of the header */}
					<header className="w-screen h-auto bg-[#0C0950] flex flex-col justify-center">
						...
						<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.4rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
							I’m a Frontend Developer with a strong passion for building
							elegant, user-centered web applications.
						</p>
						<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.2rem] px-[1rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
						...
						<div className="flex justify-center mt-6 lg:w-[65%] lg:mx-auto">
							<button className="uppercase text-cyan-200 border border-cyan-500 px-6 py-3 rounded-[100%] hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-500">
								More about me
							</button>
						</div>
					</header>
