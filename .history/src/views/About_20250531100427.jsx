...
export default function About() {
	...
	return (
		<AnimatePresence mode="wait">
			...
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[1rem] lg:pt-[2rem]">
					...
					<div className="lg:w-[40rem] lg:h-[40rem] mt-[5rem] lg:mt-0 lg:pt-[5rem] lg:order-2 md:flex md:justify-center ">
						<img
