	...
	return (
		<AnimatePresence mode="wait">
			<motion.main
				...
				className="w-screen h-auto bg-[#33c9ff] text-[1.4rem] text-[#09063a] font-tinos  flex flex-col justify-center lg:text-[1.6rem]"
			>
				<h1 className="font-unna font-bold px-[1rem] leading-[2rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
					Hello, I'm Ebenezer Tiewei
				</h1>
				<p className="font-thin leading-[2.5rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:mx-auto">
				...
				<div className="flex justify-center w-screen mx-auto mt-20 mb-[10rem] lg:w-[65%] lg:mx-auto">
					<Link
						to="/about"
						className="inline-block uppercase text-[1rem] text-cyan-200 border shadow-deep border-cyan-500 px-6 py-3 rounded-full hover:bg-cyan-500 hover:text-[#0C0950] hover:font-bold transition-all duration-500"
					>
						More about me
					</Link>
				</div>
