		...
		<>
			...
			>
				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] overflow-hidden lg:flex lg:justify-center lg:items-center">
					...
					{/* TIEWIE container */}
					<div
						className={`relative w-screen h-[50dvh] flex flex-col justify-start items-center lg:h-[100vh] lg:flex lg:justify-center lg:w-[50vw] transition-all duration-500 ease-in-out z-20 will-change-transform ${
							slideOut
								? "translate-y-[200%] lg:-translate-y-0 lg:translate-x-full"
								: ""
						}`}
