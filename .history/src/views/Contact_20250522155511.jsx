...
export default function Contact() {
	...
	return (
		<div className="bg-[#1c1860] h-auto mx-auto flex flex-col justify-between mx-[1rem] mt-[5rem] mb-[10rem] px-[2rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:flex-row lg:gap-[4rem]  lg:py-[5rem]">
