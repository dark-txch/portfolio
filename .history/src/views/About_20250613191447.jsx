	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#33c9ff] font-tinos  leading-[2rem] text-[1.7rem] text-[#09063a] lg:text-[1.5rem] lg:px-[2rem] lg:bg-[#33c9ff]"
			>
				...
				<div className="flex justify-center mt-20 pb-[10rem]">
					<a
						...
						className="inline-block uppercase text-cyan-200 bg-[#09063a] border shadow-deep border-cyan-500 text-base px-6 py-3 rounded-full hover:bg-cyan-200 hover:text-[#0C0950] hover:font-bold transition-all duration-500"
					>
						Download my resume
					</a>
				</div>
