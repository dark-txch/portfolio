	...
	return (
		<AnimatePresence mode="wait">
			<motion.main
				...
				className="w-screen h-auto bg-[#33c9ff] text-[1.4rem] text-[#09063a] font-tinos  leading-[2rem] flex flex-col justify-center lg:text-[1.6rem]"
			>
				<h1 className="font-unna font-bold px-[1rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
