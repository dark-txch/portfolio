			...
			>
				...
				<main className="-translate-y-full ">
					<header className="w-screen h-screen bg-[#0C0950]">
						<nav className=" text-white text-[1rem] w-screen shadow  px-[1rem] uppercase border-[0.3rem] border-solid border-red-500 lg:flex lg:items-center justify-between ">
							<ul>
