		...
		<AnimatePresence mode="wait">
			...
			>
				...
				<div className="flex justify-center w-screen mx-auto mt-20 mb-[10rem] lg:w-[65%] lg:mx-auto">
					<Link
						to="/about"
						className="inline-block uppercase text-cyan-200 bg-[#09063a] border shadow-deep border-cyan-500 px-6 py-3 rounded-full hover:bg-[#33c9ff] hover:text-[#0C0950] hover:font-bold transition-all duration-500"
					>
						More about me
					</Link>
				</div>
