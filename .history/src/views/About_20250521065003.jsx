	...
	return (
		<div>
			...
			<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.5rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
				...
				visually pleasing and user-friendly web applications. I have developed a
				strong interest in responsive design, accessibility, and creating
				refined web applications.
			</p>
			<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.5rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
				My goal is to develop a deep understanding of the principles of software
				development and to become a proficient software engineer.
			</p>
			<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.5rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
				I am actively seeking opportunities to work on exciting projects and
				collaborate with talented individuals in the tech industry. I am
				particularly interested in roles that allow me to contribute to the
				development of innovative web applications and to learn from experienced
				professionals.
			</p>
			<p className="font-thin text-[#EAE4D5] text-[1.8rem] leading-[2.5rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto"></p>
			<div></div>
		</div>
	);
}
