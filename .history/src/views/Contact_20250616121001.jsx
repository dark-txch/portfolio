	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="w-screen h-auto bg-[#33c9ff] font-tinos  leading-[2rem] px-[1rem] py-[5rem] text-cyan-400 lg:w-[80%] lg:mx-auto lg:my-[5rem] lg:py-[2rem] lg:flex lg:gap-[2rem] lg:text-[1.5rem]"
			>
