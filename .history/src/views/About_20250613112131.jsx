			...
			>
				<div className="flex flex-col justify-center px-[1rem] lg:flex-row lg:gap-[1rem]">
					<div className="lg:w-full order-1">
						...
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
							Growing up, the world around me was lonely and dull, i struggled to fit in, i never stayed in a place for too long and not by choice, making friends came easy for me but keeping them was a challenge, although i enjoy my company and often play chess with myself, my loneliness go
						</p>
						<p className="font-thin text-cyan-500 leading-[2.5rem] mb-[2rem]">
