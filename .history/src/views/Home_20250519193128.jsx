			...
			>
				...
				>
					<header className="w-screen h-auto bg-[#0C0950]">
						...
						{/* Body of the header */}
						<h1 className="font-unna font-medium text-cyan-200 px-[1rem] leading-[3rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
							Hello, I'm Ebenezer Tiewei &#x1F44B;
						</h1>
						<p className="text-[#EAE4D5] text-[1.8rem] leading-[2.4rem] px-[1rem] mb-[2rem] lg:w-[65%] lg:text-[2.2rem] lg:mx-auto">
