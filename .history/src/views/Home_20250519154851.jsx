	...
	return (
		<>
			...
			>
				{/* hero header */}
				<header
					className={`w-screen overflow-hidden bg-gradient-to-b from-[#5409DA] to-[#4E71FF] transition-all duration-700 ease-in-out 
    ${
			slideOut ? "h-0" : "h-[100vh] lg:flex lg:justify-center lg:items-center"
		}`}
				>
					{/* EBENEZER container */}
					<div
