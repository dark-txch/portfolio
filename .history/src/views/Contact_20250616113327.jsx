		...
		<AnimatePresence mode="wait">
			...
			>
				<div className="w-full flex text-[1.3rem] text-[#09063a] flex-col lg:justify-center pt-[2rem] lg:pt-0">
					<h1 className="font-unna font-bold leading-[2.5rem] mt-[5rem] text-[2.5rem] bg-gradient-to-r from-[#09063a] to-[#33c9ff] bg-clip-text text-transparentmb-[1.5rem] lg:text-[3rem]">
						Let's collaborate
					</h1>
					<p className="mb-[5rem]">
