...
export default function Home() {
	...
	return (
		<AnimatePresence mode="wait">
			...
			>
				<h1 className="font-unna font-bold text-cyan-300 px-[1rem] leading-[3rem] mt-[5rem] text-[2.5rem] mb-[1.5rem] lg:w-[65%] lg:mx-auto lg:text-[3rem]">
				...
				<div className="flex justify-center w-screen mx-auto mt-20 mb-[10rem] lg:w-[65%] lg:mx-auto">
					<Link
						to="/about"
						className="inline-block uppercase text-[1rem] text-cyan-200 border shadow-deep border-cyan-500 px-6 py-3 rounded-full hover:bg-cyan-500 hover:text-[#0C0950] transition-all duration-500"
					>
						More about me
					</Link>
				</div>
