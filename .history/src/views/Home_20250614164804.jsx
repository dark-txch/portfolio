	...
	return (
		<AnimatePresence mode="wait">
			<motion.main
				...
				className="w-screen h-auto bg-[#33c9ff] text-[1.4rem] text-[#09063a] font-tinos  leading-[2rem] px-[1rem] flex flex-col justify-center lg:text-[1.6rem]"
			>
				...
				<p className="font-thin leading-[2.5rem]  mb-[2rem]">
