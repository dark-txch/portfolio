...
export default function Contact() {
	...
	return (
		<AnimatePresence mode="wait">
			...
			>
				<div className="bg-[#1c1860] h-auto flex flex-col justify-betweenpx-[1rem] rounded-tl-[4rem] rounded-br-[4rem] lg:w-[80%] lg:mx-auto lg:flex-row lg:gap-[4rem]  lg:py-[5rem] lg:px-[2rem]">
