		...
		<>
			...
			<div className="w-screen h-full ">
				...
				<header className="w-screen h-[100dvh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF]">
					...
					<div className="relative w-screen h-[50dvh]  border-[0.2px] border-red-500">
						<BackgroundVideo
							src="/video/gym-s.mp4"
							className="absolute top-0 left-0 w-screen h-[100%] object-cover transform translate-x-[0] translate-y-[2rem]"
						/>
