				...
				<main className="-translate-y-full">
					<header className="w-screen h-screen bg-[#0C0950]">
						<motion.nav
							...
							className="origin-left text-[0.4rem] w-screen h-[7rem] border-[0.3rem] border-solid border-red-500"
						>
							<ul className="text-white text-[1rem] flex justify-center items-center w-full h-full gap-4">
								<li>Home</li>
								<li>About</li>
								<li>Projects</li>
								<li>Contact</li>
