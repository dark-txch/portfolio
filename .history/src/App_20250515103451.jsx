				...
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] overflow-hidden lg:flex lg:justify-center lg:items-center">
					...
					>
						...
						<div className="relative flex justify-between items-end w-full px-[1rem] overflow-hidden lg:flex lg:flex-col lg:items-end lg:px-0">
							...
							<button
								onClick={handleClick}
								className="relative top-[1.8rem] text-[#b9b9b9] text-[1.3rem] font-bold bg-[#CB0404] mx-[1rem] rounded-t-[5rem] border-[0.8rem] border-[#3A0519] w-[5rem] h-[.45rem] cursor-pointer lg:top-auto lg:mx-0 lg:rounded-tl-[3rem] lg:rounded-bl-[3rem] lg:rounded-t-none lg:my-[1rem] lg:left-[2rem] lg:uppercase"
							>
