...
const ProjectStand = ({ title, images, summary, tools }) => {
	...
	return (
		<div className="lg:w-[50%]">
			...
			{/* desktop stand */}
			<div className="w-[3rem] h-[4rem] bg-[#6DE1D2] mx-auto md:hidden lg:block"></div>
			<div className="w-[60%] h-[1rem] bg-[#6DE1D2] mx-auto rounded-tl-[5rem] rounded-tr-[5rem] md:block lg:block"></div>
		</div>
	);
};
