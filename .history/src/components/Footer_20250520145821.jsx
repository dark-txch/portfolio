...
const Footer = () => {
	return (
		<footer className="w-screen bg-[#1c1860] text-[#EAE4D5] py-[3rem] px-[1rem] flex flex-col lg:px-[4rem]">
					...
					<ul>
						<li className="flex gap-3 ">
							<a
								...
								aria-label="Twitter"
							>
								<RiTwitterXLine className="text-[1rem] lg:text-[1.2rem]" />
							</a>
							<a
								...
								aria-label="LinkedIn"
							>
								<FaLinkedin className="text-[1rem] lg:text-[1.2rem]" />
							</a>
							<a
								...
								aria-label="GitHub"
							>
								<FaGithub className="text-[1rem] lg:text-[1.2rem]" />
							</a>
						</li>
					</ul>
				</nav>
