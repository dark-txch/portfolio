		...
		<AnimatePresence mode="wait">
			...
			>
				<div className="bg-[#1c1860] w-full flex flex-col items-center border-[0.2rem] border-[#FFF085] rounded-[3rem]">
					<div className="bg-[#000000] w-full h-[8rem] flex justify-between p-[1rem] rounded-tl-[3rem] rounded-tr-[3rem] md:h-[15rem] lg:p-[1.5rem] lg:h-[15rem]">
						{images.map((img, idx) => (
							<img
								key={idx}
								src={img.src}
					...
					<div className="w-full bg-[#000000] pl-[1rem] pb-[1.5rem] rounded-bl-[3rem] rounded-br-[3rem] text-cyan-500">
						<button
