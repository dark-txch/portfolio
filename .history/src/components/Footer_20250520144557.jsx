...
const Footer = () => {
	return (
		<footer className="w-screen bg-cyan-500 py-[3rem] px-[1rem] flex flex-col lg:px-[4rem]">
			...
			<div className="flex flex-col gap-2 w-screen mt-[1rem] lg:flex lg:flex-row lg:justify-between">
				<nav>
					<ul>
