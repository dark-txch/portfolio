		...
		>
			<div className="w-screen min-h-screen max-h-screen overflow-hidden bg-gradient-to-b from-[#5409DA] to-[#4E71FF] flex flex-col lg:flex-row">
				...
				>
					...
					/>
					<div className="relative flex justify-between items-end w-full overflow-hidden px-[1rem] border lg:flex lg:flex-col lg:items-end lg:px-0">
						<h1 className="w-[6rem] text-[#60B5FF] text-[1rem] uppercase font-bold border pb-[0.5rem] md:w-[10rem] md:text-[1.5rem] lg:w-[15rem] lg:pr-[1rem] lg:text-right lg:text-[1.5rem] lg:order-5">
							Ebenezer
						</h1>
						...
						<h4 className="w-[6rem] text-[1rem] text-[#60B5FF] font-bold text-right pr-[0.6rem] uppercase pb-[0.5rem] border md:w-[10rem] md:text-[1.5rem] lg:w-[15rem] lg:pl-[1rem] lg:text-[2.5rem] lg:order-4">
							Frontend
						</h4>
					</div>
				</div>
				...
				>
					...
					/>
					<div className="relative flex justify-between items-start w-full px-[1rem] overflow-hidden border lg:flex lg:flex-col lg:items-start lg:px-0">
						<h1 className="w-[6rem] text-[#60B5FF] text-[1rem] font-bold uppercase border pt-[0.5rem] md:w-[10rem] lg:pt-0 lg:pb-[0.5rem] md:text-[1.5rem] lg:w-[15rem] lg:pl-[1rem] lg:text-[1.5rem] lg:order-5">
							Tiewei
						</h1>
						...
						<h4 className="w-[6rem] text-[1.2rem] text-[#60B5FF] font-bold text-right pr-[0.3rem] uppercase pt-[0.5rem] border md:w-[10rem] md:text-[1.5rem] lg:text-left lg:pb-[0.5rem] lg:pt-0 lg:w-[15rem] lg:pl-[1rem] lg:text-[2.5rem] lg:order-4">
							Developer
						</h4>
					</div>
				</div>
