									...
									<div className="pl-[2.8rem] pr-[1rem] border-b-[0.1px] rounded-bl-[3rem] rounded-br-[3rem] border-cyan-500 pt-2 pb-2">
										...
										<ul className="flex flex-wrap gap-3 ">
											{tools.map((tool) => (
												<li
													key={tool}
													className="flex items-center gap-2 mb-[1rem] border"
												>
													<GoDotFill
														className="text-cyan-200 text-[1.3rem] font-thin font-unna mb-3 "
														size={10}
													/>
													<span className="text-[1.3rem] font-thin font-unna mb-3 text-cyan-400">
														{tool}
													</span>
												</li>
											))}
										...
										<a
											...
											className="text-[1.2rem] text-cyan-200 font-bold font-unna mb-1 flex items-center gap-3 w-fit hover:text-green-400 hover:scale-[1.1] transition- duration-300"
										>
