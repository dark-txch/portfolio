		...
		<header>
			<nav className="relative text-[1rem] w-screen shadow h-[6rem] flex justify-between items-center px-[1rem] uppercase lg:flex lg:items-center lg:justify-between lg:px-[3rem]">
				...
				<div className="text-[#EAE4D5] hover:text flex gap-5 lg:gap-[2rem]">
					...
					<ul
						className={`fixed top-0 right-0 h-full w-[80vw] max-w-[20rem] bg-[#09063a] z-50 transition-all duration-500 ease-in-out
		${
			isMenuOpen
				? "translate-x-0 opacity-100 pointer-events-auto"
				: "translate-x-full opacity-0 pointer-events-none"
		} 
		lg:static lg:translate-x-0 lg:opacity-100 lg:pointer-events-auto lg:flex lg:gap-[2rem] lg:flex-row lg:h-auto lg:w-auto lg:bg-transparent`}
					>
