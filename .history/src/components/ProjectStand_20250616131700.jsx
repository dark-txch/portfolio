							...
							{isOpen && (
								...
								>
									<div className="pl-[2.8rem] pr-[1rem] border-b-[0.1px] rounded-bl-[3rem] rounded-br-[3rem] border-cyan-500 pt-2 pb-2">
										...
										<ul className="flex flex-wrap gap-3 ">
											{tools.map((tool) => (
												...
												>
													...
													<span className="text-[1.2rem] font-bold font-unna mb-1 text-cyan-200">{tool}</span>
												</li>
											))}
										</ul>
										<a
										...
										>
											<FaHandPointRight className="text-[1.2rem] font-bold font-unna mb-1 text-cyan-200" />
											View project
										</a>
									</div>
								</motion.div>
