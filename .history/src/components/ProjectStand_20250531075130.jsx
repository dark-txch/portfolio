				...
				<div className="bg-[#1c1860] w-full flex flex-col items-center border-[0.5rem] border-[#6DE1D2] rounded-[3rem]">
					...
					<div className="w-full bg-[#000000] pb-[1rem] rounded-bl-[3rem] rounded-br-[3rem] text-cyan-500">
						<button
							...
							className="uppercase flex gap-3 items-center text-cyan-400 text-[1rem] pl-[1rem] pt-[1rem]"
						>
							{isOpen ? (
								<FaHandPointRight />
							) : (
						...
						<AnimatePresence>
							{isOpen && (
								...
								>
									<div className="pl-[2.8rem] pr-[1rem] border-b-[0.1px] rounded-bl-[3rem] rounded-br-[3rem] border-cyan-400 pt-2 pb-2">
										...
										<a
											...
											className="text-[1.2rem] font-bold mb-1 flex items-center gap-3 w-fit hover:text-green-400 hover:scale-[1.1] transition- duration-300"
										>
											<FaHandPointRight />
											View project
										</a>
