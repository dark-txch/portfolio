								...
								>
									<div className="pl-[2.8rem] pr-[1rem] border-b-[0.1px] rounded-bl-[3rem] rounded-br-[3rem] border-cyan-500 pt-2 pb-2">
										...
										<a
											...
											className="text-[1.2rem] text-cyan-300 font-bold font-unna  font-bold 
											mb-1 flex items-center gap-3 w-fit hover:text-green-400 hover:scale-[1.1] transition- duration-300"
										>
