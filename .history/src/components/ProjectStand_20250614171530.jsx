		...
		<AnimatePresence mode="wait">
			...
			>
				<div className="bg-[#09063a] w-full flex flex-col items-center border-[0.5rem] border-[#09063a] rounded-[3rem]">
					...
					<div className="w-full bg-[#09063a] font-tinos  leading-[2rem] pb-[1.5rem] rounded-bl-[3rem] rounded-br-[3rem] text-cyan-200">
						<button
							onClick={() => setIsOpen(!isOpen)}
							className="uppercase flex gap-3 items-center text-[1rem] pl-[1rem] pt-[1rem]"
						>
							{isOpen ? (
