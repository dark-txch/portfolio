...
const Footer = () => {
	return (
		<footer className="w-screen bg-cyan-500 py-[3rem] px-[1rem] flex flex-col">
			...
			<div className="flex flex-col gap-2 w-screen lg:flex lg:flex-row lg:justify-between">
				<nav>
					<ul>
				...
				<div className="lg:pr">&copy; designed &amp; built by Ebenezer Tiewei</div>
			</div>
		</footer>
	);
};
