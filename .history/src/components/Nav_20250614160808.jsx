...
const Nav = ({ onHeroLinkClick }) => {
	...
	return (
		<header>
			<nav className="relative text-[1.rem] w-screen shadow h-[6rem] flex justify-between items-center px-[1rem] uppercase lg:flex lg:items-center lg:justify-between lg:px-[2rem]">
