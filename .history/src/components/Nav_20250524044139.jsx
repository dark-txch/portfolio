				...
				<div className="text-[#EAE4D5] hover:text flex gap-5 lg:gap-[2rem]">
					...
					>
						<li className="text-[#EAE4D5] hover:text-cyan-200 duration-500">
							<Link to="/home" className="w-screen flex justify-center border lg:w-auto lg:jus">
								Home
							</Link>
						</li>
						<li className="text-[#EAE4D5] hover:text-cyan-200 duration-500">
							<Link to="/about" className="w-screen flex justify-center">
								About
							</Link>
						</li>
						<li className="text-[#EAE4D5] hover:text-cyan-200 duration-500">
							<Link to="/projects" className="w-screen flex justify-center">
								Projects
							</Link>
						</li>
						<li className="text-[#EAE4D5] hover:text-cyan-200 duration-500">
							<Link to="/contact" className="w-screen flex justify-center">
								Contact
							</Link>
						</li>
