	...
	return (
		<AnimatePresence mode="wait">
			...
			>
				...
				{/* desktop stand */}
				<div className="w-[3rem] h-[4rem] bg-[#] mx-auto hidden md:hidden lg:block"></div>
				<div className="w-[60%] h-[1rem] bg-[#] mx-auto rounded-tl-[5rem] rounded-tr-[5rem] hidden md:block lg:block"></div>
			</motion.div>
		</AnimatePresence>
	);
};
