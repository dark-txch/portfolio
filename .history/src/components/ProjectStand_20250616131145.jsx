							...
							{isOpen && (
								...
								>
									<div className="pl-[2.8rem] pr-[1rem] border-b-[0.1px] rounded-bl-[3rem] rounded-br-[3rem] border-cyan-500 pt-2 pb-2">
										<h4 className="text-[1.2rem] font-bold uppercase font-unna mb-1 text-cyan-300">
											Summary:
										</h4>
										<p className="text-[1.1rem] font-thin mb-3 text-cyan-500">
											{summary}
										</p>
										<h4 className="text-[1.2rem] font-bold mb-1 text-cyan-300">
											Tools:
										</h4>
