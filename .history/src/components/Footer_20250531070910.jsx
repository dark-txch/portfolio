...
const Footer = () => {
	return (
		<footer className="w-screen bg-[#1c1860] text-cyan-500 py-[3rem] px-[1rem] flex flex-col lg:px-[3rem]">
			<div className="flex flex-col items-end">
				<h6>Would you like to support my content?</h6>
				<p className="flex flex-col items-end text-[1.1rem] text-cyan-300">
