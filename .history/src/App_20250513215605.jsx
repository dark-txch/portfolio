	...
	return (
		<>
			...
			<div className="w-screen h-full ">
				{/* hero header  */}
				<header className="w-screen h-[100vh] bg-gradient-to-b from-[#5409DA] to-[#4E71FF] lg:flex lg:justify-center lg:align-middle">
					...
					<div className="relative w-screen h-[50dvh] flex flex-col justify-end items-center lg:h-[100vh] lg:w-[50vw]">
						...
						<div className="flex justify-between items-center w-full px-[2rem]">
							<h1 className="relative text-[2rem] lg:text-[5rem] text-white">
								Ebenezer
							</h1>
							<h4 className="relative text-[1rem] text-white">Front End</h4>
						</div>
					...
					<div className="relative w-screen h-[50dvh] flex flex-col justify-start items-center">
						...
						<div className="flex justify-between items-center w-full px-[2rem]">
							<h1 className="relative text-[2rem] text-white">Tiewei</h1>
							<h4 className="relative text-[1rem] text-white">Developer</h4>
						</div>
					</div>
				</header>
